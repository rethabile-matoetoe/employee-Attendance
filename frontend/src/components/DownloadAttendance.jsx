...
function DownloadAttendance() {
  ...
  const generatePDF = (data) => {
    ...
    const attendanceRate = ((presentCount / data.length) * 100).toFixed(1)
    ...
    data.forEach((record, index) => {
      ...
      doc.text(record.employeeName, 25, yPosition)
      doc.text(record.employeeID, 70, yPosition)
      doc.text(record.date, 110, yPosition)
